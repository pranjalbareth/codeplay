"""
Django settings for devlogs project.
...
SECRET_KEY = '%#nq#iafpu^2#5ej%8f0k+l^r7ow8m!*!n)3n00&^!gjbr&d3c'
...
ROOT_URLCONF = 'devlogs.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['/home/pranjalbareth/codeplay/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'devlogs.wsgi.application'
